...
const translations: Record<Language, Translations> = {
  en: {
    ...
    howItWorks: {
      ...
      step1Text: 'Sign up in seconds and get 50 free messages per day.',
  ...
  pt: {
    ...
    howItWorks: {
      ...
      step1Text: 'Cadastre-se em segundos e ganhe 50 mensagens grátis por dia.',
  ...
  es: {
    ...
    howItWorks: {
      ...
      step1Text: 'Regístrate en segundos y obtén 50 mensajes gratis por día.',
  ...
  fr: {
    ...
    howItWorks: {
      ...
      step1Text: 'Inscrivez-vous en quelques secondes et obtenez 50 messages gratuits par jour.',
  ...
  de: {
    ...
    howItWorks: {
      ...
      step1Text: 'Registrieren Sie sich in Sekunden und erhalten Sie 50 kostenlose Nachrichten pro Tag.',
